...
MODEL_NAME=${MODEL_NAME_QWEN2_5VL_3B}
VERSION=${VERSION_QWEN2_5VL_3B}
...
## Attention Score
ATTN_NUM_FRAME=16
attn_layer_idx_start=18
attn_layer_idx_end=-1 # -1 means the last layer
ATTN_MS_CFG="--attn_max_token 400 --attn_resize_scale 2 --attn_max_batch 6" # for 80GB GPU
